...
#cur.execute("insert into paymentsf values(1,'AYUSH','SHAH','8799146289','ayushs1904@gmail.com',2,'1','11','2018','11:20:27 PM','Cash','3500')")
...
Label(sroot,text="AYUSH SHAH",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=180)
Label(sroot,text="ayushs1904@gmail.com",font='Timesnewroman 40',bg='white',fg='black').place(x=535,y=270)
Label(sroot,text="8799146289",font='Timesnewroman 40',bg='white',fg='black').place(x=535,y=270)
...
def mainroot():
	...
	root.title("MADE WITH LOVE BY AYUSH 🥰")
	...
	def hotel_status():
		...
		nl = Label(b_frame,text='MADE BY AYUSH',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="MR. AYUSH SHAH",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="MR. PRATIK CHAUHAN",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="MR. NARSI SOLANKI (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="MS. AAKRITI MISHRA (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
